...
(:action clean
       :parameters  ()
       :precondition (and (holding) (not (empty)) (not (containIg1)) (not (containIg2)) (not (containIg3)) (not (containIg4)) (not (containIg5)) (not (containIg6)) (not (containIg7)) (not (containCt)) )
...
(:action shake
       :parameters  ()
       :precondition (and  (holding) (containIg1) (containIg2) (containIg3) (containIg4) (containIg5) (containIg6) (containIg7))
       :effect (and (not (containIg1)) (not (containIg2)) (not (containIg3)) (not (containIg4)) (not (containIg5)) (not (containIg6)) (not (containIg7)) (containCt) )
)
